...
const SearchEvent = () => {
    ...
    async function search(key) {
        let result = await fetch('http://127.0.0.1:8000/api/searchevent/' + key);
    ...
    return (
        <>
            <Header />
            <h1 className=' text-center'> Search Event </h1> <br /> <br />
            ...
            <Container className="container mt-5">
...

                {
                    ...
                    data.length === 0 ? <p className=' text-center text-primary-emphasis'>  No event found  </p> :
                        data.map((elem) => {
                            return (
                                <Card key={elem.id}>
                                    <div className="card">
